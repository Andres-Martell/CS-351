// global vars
 ...
 var dif = [1.0, 1.0, 1.0];
  ...
  // Lights
  var MouseLamp = new LightsT();  // mouse 
  var camLamp = new LightsT();  // camera 
  var roofLamp = new LightsT();  //  ceiling 
  var MouseLampOn = 1;  
  var camLampOn = 0;  
  var roofLampOn = 0;  
 
 MouseLamp.I_pos.elements.set([2.0, 1.0, 3.0]);
 MouseLamp.I_ambi.elements.set(amb);
 MouseLamp.I_diff.elements.set(dif);
 MouseLamp.I_spec.elements.set(spe);
 
 camLamp.I_pos.elements.set([-2.0, 1.0, 3.0]);  
 camLamp.I_ambi.elements.set(amb);
 camLamp.I_diff.elements.set(dif);
 camLamp.I_spec.elements.set(spe);
 
 roofLamp.I_pos.elements.set([0, 0, 5.0]);
 roofLamp.I_ambi.elements.set(amb);
 roofLamp.I_diff.elements.set(dif);
 roofLamp.I_spec.elements.set(spe); 

 // Materials	

 //var matlSel0 = MATL_TURQUOISE;
...
function VBObox1() {
    ...
    mySiz =  sphVerts1.length  + cubeVerts.length + pyrVerts.length;
...
VBObox1.prototype.draw = function() {
    ...
    pushMatrix(this.ModelMat);
    this.ModelMat.translate(1.3,-1.3,0);
    drawForest(this.ModelMat, this.u_ModelMatLoc, this.u_MvpMatLoc, this.u_NormalMatrix);  

    this.ModelMat = popMatrix();
    pushMatrix(this.ModelMat);
    this.ModelMat.translate(-1.7,2.2,0);
    drawForest(this.ModelMat, this.u_ModelMatLoc, this.u_MvpMatLoc, this.u_NormalMatrix);  

    this.ModelMat = popMatrix();
    pushMatrix(this.ModelMat);
    this.ModelMat.translate(2.5,-1.3,0);
    drawForest(this.ModelMat, this.u_ModelMatLoc, this.u_MvpMatLoc, this.u_NormalMatrix);  
    ...
    this.ModelMat = popMatrix();
    pushMatrix(this.ModelMat);
    this.ModelMat.translate(-1,-1.5,0);
    drawForest(this.ModelMat, this.u_ModelMatLoc, this.u_MvpMatLoc, this.u_NormalMatrix); 
...
function VBObox2() {
    ...
    'uniform int u_MouseLampOn;\n' +
    'uniform int u_camLampOn;\n' +
    'uniform int u_roofLampOn;\n' +
    'uniform int u_blinnOn;\n' +
    ...
    this.MouseLamp = new LightsT();
    this.MouseLamp.u_pos;
    this.MouseLamp.u_ambi;
    this.MouseLamp.u_diff;
    this.MouseLamp.u_spec;

    this.camLamp = new LightsT();
    this.camLamp.u_pos;
    this.camLamp.u_ambi;
    this.camLamp.u_diff;
    this.camLamp.u_spec;

    this.roofLamp = new LightsT();
    this.roofLamp.u_pos;
    this.roofLamp.u_ambi;
    this.roofLamp.u_diff;
    this.roofLamp.u_spec;
...
VBObox2.prototype.init = function() {
    ...
    this.u_MouseLampOn = gl.getUniformLocation(this.shaderLoc, 'u_MouseLampOn');
    this.u_camLampOn = gl.getUniformLocation(this.shaderLoc, 'u_camLampOn');
    this.u_roofLampOn = gl.getUniformLocation(this.shaderLoc, 'u_roofLampOn');
    if (!this.u_MouseLampOn || !this.u_camLampOn || !this.u_roofLampOn) { 
        console.log(this.constructor.name + 
                              '.init() failed to get GPU location for lamp switches.');
        return;
    }
    this.u_blinnOn = gl.getUniformLocation(this.shaderLoc, 'u_blinnOn');
    ...
    this.roofLamp.u_pos = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[2].pos');
    this.roofLamp.u_ambi = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[2].a');
    this.roofLamp.u_diff = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[2].d');
    this.roofLamp.u_spec = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[2].s');

    this.MouseLamp.u_pos = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[0].pos');
    this.MouseLamp.u_ambi = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[0].a');
    this.MouseLamp.u_diff = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[0].d');
    this.MouseLamp.u_spec = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[0].s');

    this.camLamp.u_pos = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[1].pos');
    this.camLamp.u_ambi = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[1].a');
    this.camLamp.u_diff = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[1].d');
    this.camLamp.u_spec = gl.getUniformLocation(this.shaderLoc, 'u_LampSet[1].s');

    

   
    if(!this.MouseLamp.u_pos || !this.MouseLamp.u_ambi || !this.MouseLamp.u_diff || !this.MouseLamp.u_spec ) {
        console.log(this.constructor.name + 
                              '.init() failed to get GPU location for MouseLamp.');
        return;
    }
    if(!this.camLamp.u_pos || !this.camLamp.u_ambi || !this.camLamp.u_diff || !this.camLamp.u_spec) {
        console.log(this.constructor.name + 
                              '.init() failed to get GPU location for camLamp.');
        return;
    }
    if(!this.roofLamp.u_pos || !this.roofLamp.u_ambi || !this.roofLamp.u_diff || !this.roofLamp.u_spec) {
        console.log(this.constructor.name + 
                              '.init() failed to get GPU location for roofLamp.');
        return;
    }
...
VBObox2.prototype.adjust = function() {
    ...
    gl.uniform3fv(this.MouseLamp.u_pos, MouseLamp.I_pos.elements.slice(0,3)); // Set the light direction (in the world coordinate)
    gl.uniform3fv(this.MouseLamp.u_ambi, MouseLamp.I_ambi.elements); 
    gl.uniform3fv(this.MouseLamp.u_diff, MouseLamp.I_diff.elements);
    gl.uniform3fv(this.MouseLamp.u_spec, MouseLamp.I_spec.elements);

    gl.uniform3fv(this.camLamp.u_pos, camLamp.I_pos.elements.slice(0,3)); // Set the light direction (in the world coordinate)
    gl.uniform3fv(this.camLamp.u_ambi, camLamp.I_ambi.elements); 
    gl.uniform3fv(this.camLamp.u_diff, camLamp.I_diff.elements);
    gl.uniform3fv(this.camLamp.u_spec, camLamp.I_spec.elements);

    gl.uniform3fv(this.roofLamp.u_pos, roofLamp.I_pos.elements.slice(0,3)); // Set the light direction (in the world coordinate)
    gl.uniform3fv(this.roofLamp.u_ambi, roofLamp.I_ambi.elements); 
    gl.uniform3fv(this.roofLamp.u_diff, roofLamp.I_diff.elements);
    gl.uniform3fv(this.roofLamp.u_spec, roofLamp.I_spec.elements);
    ...
    gl.uniform1i(this.u_MouseLampOn, MouseLampOn);
    gl.uniform1i(this.u_camLampOn, camLampOn);
    gl.uniform1i(this.u_roofLampOn, roofLampOn);

    gl.uniform1i(this.u_blinnOn, blinnOn);
